...
/**
 * This is the model class for table "view_location".
 *
 * The followings are the available columns in table 'view_location':
 ...
 */
class ViewLocation extends CActiveRecord
{
	/**
	 ...
	 * @return ViewLocation the static model class
	 */
