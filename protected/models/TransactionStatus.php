 ...
 */
class TransactionStatus extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('transaction_id, status, input_by, update_by', 'length', 'max'=>255),
			array('input_date, update_date', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, transaction_id, status, input_date, input_by, update_date, update_by', 'safe', 'on'=>'search'),
		);
	}
